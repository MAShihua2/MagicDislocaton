In this directory, we try to create a dislocation (1/2<111>) for a BCC system via inserting a new half layer and then moving atoms. b and d represent dislocations with different slopes.
